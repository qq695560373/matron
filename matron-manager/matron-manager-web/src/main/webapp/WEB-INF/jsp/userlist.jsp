                    ...
                    <div class="col-md-12" >
                        <form role="form" id="addForm" method="post">
                            <div class="box-body">
                                ...
                                <div class="form-group col-md-3" style="padding-left:0">
                                    <label for="permissionid"  class="text-red">权限级别</label></br>
                    ...
                    for(var i=0;i<list.length;i++){
                        if(i>=(currentPage-1)*pageSize&&i<currentPage*pageSize) {
                            ...
                            innerHtml += "<tr onclick='selected("+i+")'><td><input id='id"+i+"' type='checkbox' value="+obj.id+" name='checkBox'/></td><td>" +
                                getStr(obj.name) + "</td><td>" +
                                getStr(obj.nickname) + "</td><td>" +
                                getStr(obj.username) + "</td><td>" +
                                getStr(obj.password) + "</td><td>";
                            if(obj.ismatron==1){
                                innerHtml +=getStr("是") + "</td><td>";
                            }else{
                                innerHtml +=getStr("否") + "</td><td>";
                            }
                            innerHtml += getStr(obj.phone) + "</td><td>" +
                                getStr(obj.email) + "</td><td>" +
                                getStr(obj.permissionid) + "</td></tr>";
                        }
                    }
